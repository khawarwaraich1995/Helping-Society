...
const renderItem = ({ item }) => {
    return (
        <View style={{ backgroundColor: '#fff', elevation: 5, marginHorizontal: 12, marginVertical: 10,  borderRadius: 8, flexDirection: 'row' }}>
            <View>
                <View style={{ backgroundColor: 'orange', width: 10, flex: 1,borderTopLeftRadius:8,borderBottomLeftRadius:8  }}></View>
            </View>
            <View style={{flex:1}}>
                <View style={{alignSelf:'flex-end',marginRight:10}}>
                    <Text style={{fontSize:16,fontFamily:'Ubuntu-Bold',color:'orange'}}>Type: {item.type}</Text>
                </View>
