...
export default class RegisterComplaint extends Component {
  ...
  // Complaint Api //
  handleComplaint() {
    const {issueType, address, city, postalCode, message, image1,image, lat, lng} =
      this.state;
    if (issueType == '') {
  ...
  render() {
    return (
      <ScrollView
        ...
        contactContainerStyle={{flexGrow: 1, backgroundColor: '#fff'}}>
              ...
              {this.state.image ? (
                <View>
                  <Image
                    ...
                    style={{height: 63, width: 63, borderRadius: 50}}
                  />
                </View>
              ) : (
                <View>
